...
#
start = time.time()
popt=[0.0,2e-4,5e-2,0.1,0.00,5e-4]
popt, pcov = curve_fit(fit_func, bias_data, dIdV_data, p0=popt,bounds=([-20.,0.0,0.0,-pi,-np.inf,-np.inf],[20.,100.,200.,pi,np.inf,np.inf]))
end = time.time()
print( "*** Fit converged ***" )
print()
